...
const CITY_LANGUAGES_MAP = {
    ...
    "Vadodara": ["Gujarati", "Hindi"],
    "Coimbatore": ["Tamil", "Hindi"],
    "Agra": ["Hindi"],
    "Ludhiana": ["Punjabi"],
    "Madurai": ["Tamil"],
    "Guwahati": ["Assamese", "Bengali", "Hindi"],
    ...
    "Aligarh": ["Hindi", "Urdu"],
    "Guntur": ["Telugu"],
    "Bhiwandi": ["Marathi", "Hindi"],
    "Saharanpur": ["Hindi", "Urdu"],
    "Gorakhpur": ["Hindi"],
    "Bikaner": ["Hindi", "Rajasthani"],
    "Amravati": ["Marathi", "Hindi"],
    "Noida": ["Hindi"],
    "Jamshedpur": ["Hindi", "Bengali"],
    "Bhilai": ["Hindi", "Chhattisgarhi"],
    "Cuttack": ["Odia"],
    "Firozabad": ["Hindi"],
    "Kochi": ["Malayalam"],
    "Nellore": ["Telugu", "Hindi"],
    "Bhavnagar": ["Gujarati", "Hindi"],
    "Dehradun": ["Hindi"],
    "Durgapur": ["Bengali"],
    "Asansol": ["Bengali"],
    "Rourkela": ["Odia", "Hindi"],
    "Nanded": ["Marathi"],
    "Kolhapur": ["Marathi", "Hindi"],
    "Ajmer": ["Hindi", "Rajasthani"],
    "Akola": ["Marathi", "Hindi"],
    "Gulbarga": ["Kannada", "Urdu"],
    "Jamnagar": ["Gujarati", "Hindi"],
    "Ujjain": ["Hindi", "Malvi"],
    "Loni": ["Hindi"],
    "Siliguri": ["Bengali", "Nepali"],
    "Jhansi": ["Hindi"],
    "Ulhasnagar": ["Sindhi", "Hindi", "Marathi"],
    "Jammu": ["Dogri", "Hindi", "Urdu"],
    "Sangli": ["Marathi", "Hindi"],
    "Erode": ["Tamil"],
    "Belgaum": ["Kannada", "Marathi", "Hindi"],
    "Ambattur": ["Tamil"],
    "Tirunelveli": ["Tamil"],
    "Malegaon": ["Marathi", "Hindi", "Urdu"],
    "Gaya": ["Hindi", "Magahi"],
    "Jalgaon": ["Marathi", "Hindi"],
    "Udaipur": [ "Rajasthani"],
    "Maheshtala": ["Bengali", "Hindi"],
    "Srinagar": ["Kashmiri", "Urdu", "Hindi"],
    "Aurangabad": ["Marathi", "Hindi", "Urdu"],
    "Dhanbad": ["Hindi", "Bengali"],
    "Amritsar": ["Punjabi", "Hindi"],
    "Allahabad": ["Hindi", "Urdu"],
    "Ranchi": ["Hindi", "Santali"],
    "Howrah": ["Bengali", "Hindi"],
    "Jalandhar": ["Punjabi", "Hindi"],
    "Jodhpur": ["Hindi", "Rajasthani"],
    "Raipur": ["Hindi", "Chhattisgarhi"],
    "Kota": ["Hindi", "Rajasthani"],
    "Gurgaon": ["Hindi", "Haryanvi"],
    "Moradabad": ["Hindi", "Urdu"],
    ...
    return (
        <div className="space-y-10">
            ...
            <div className="p-8 bg-indigo-50 border border-indigo-200 rounded-xl shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="pt-2 border-t pt-4">
                        {isRecording && !recordingRequestText ? (
                            <button
                                type="button"
                        ...
                        ) : recordedBlob && !recordingRequestText ? (
                            ...
                            <button
                                ...
                                disabled={!!recordingRequestText}
                                className="w-full bg-green-600 text-white py-3 px-4 rounded-full font-semibold hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center transition duration-150 shadow-lg shadow-green-300/50"
                            >
                    ...
                    <button
                        type="submit"
                        disabled={isUploading || !recordedBlob || !language || (!recordingRequestText && !phraseId)}
            ...
            <div className="p-8 bg-white border border-gray-200 rounded-xl shadow-lg">
                ...
                {/* Display fulfillment banner when fulfilling a request */}
                {recordingRequestText && (
                    <div className="mb-4 p-4 bg-green-100 border border-green-300 rounded-lg shadow-inner text-center">
