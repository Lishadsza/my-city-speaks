...
// import { Upload, Mic, MicOff, Play, RotateCcw, FileAudio, Globe, Home, Phone } from "lucide-react";
...
//       {/* Navigation */}
//       <nav className="bg-slate-800/80 backdrop-blur-sm border-b border-white/10">
...
//                 <span>Home</span>
//               </a>
//               <a href="/analysis" className="flex items-center space-x-2 text-white/80 hover:text-white transition-colors">
